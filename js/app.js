...
const displayPhoneDetails = phone => {
    ...
    <hr>
    <p>Chipset: ${phone.mainFeatures ? phone.mainFeatures.chipSet : 'No Information Found'}</p>
    <p>Display: ${phone.mainFeatures ? phone.mainFeatures.displaySize : 'No Information Found'}</p>
    ...
    <p>GPS: ${phone.others ? phone.others.GPS : 'No Information Found'}</p>
    <p>NFC: ${phone.others ? phone.others.NFC : 'No Information Found'}</p>
    <p>Radio: ${phone.others ? phone.others.Radio : 'No Information Found'}</p>
    <p>USB: ${phone.others ? phone.others.USB : 'No Information Found'}</p>
